...
void RaceGame::horseInsert()//말 마릿수를 입력함
{
	...
	horses = n;				//입력받은 숫자만큼 horses에 저장
}

void RaceGame::pickInsert() //내 말을 선택함
{
...
void RaceGame::run() {
	...
	horseInsert();			//말 마릿수를 입력받는 메소드

	cout << "몇 번째 말을 선택하시겠습니까?" << endl;
	pickInsert();			//내 말을 선택하는 메소드
